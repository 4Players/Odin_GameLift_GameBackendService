...
import type { PortDefinitionRequest } from './PortDefinitionRequest';
import {
    PortDefinitionRequestFromJSON,
    PortDefinitionRequestFromJSONTyped,
    PortDefinitionRequestToJSON,
    PortDefinitionRequestToJSONTyped,
} from './PortDefinitionRequest';
 ...
 * 
 * @export
 * @interface StoreServerConfigRequest
 */
export interface StoreServerConfigRequest {
    /**
     * The name of the server configuration
     * @type {string}
     * @memberof StoreServerConfigRequest
     */
    name: string;
    /**
 ...
 */
export function instanceOfStoreServerConfigRequest(value: object): value is StoreServerConfigRequest {
...
export function StoreServerConfigRequestFromJSON(json: any): StoreServerConfigRequest {
    return StoreServerConfigRequestFromJSONTyped(json, false);
}

export function StoreServerConfigRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): StoreServerConfigRequest {
    if (json == null) {
        return json;
    }
    return {
        ...
        'ports': json['ports'] == null ? undefined : ((json['ports'] as Array<any>).map(PortDefinitionRequestFromJSON)),
    };
}

export function StoreServerConfigRequestToJSON(json: any): StoreServerConfigRequest {
    return StoreServerConfigRequestToJSONTyped(json, false);
}

export function StoreServerConfigRequestToJSONTyped(value?: StoreServerConfigRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'ports': value['ports'] == null ? undefined : ((value['ports'] as Array<any>).map(PortDefinitionRequestToJSON)),
    };
}
