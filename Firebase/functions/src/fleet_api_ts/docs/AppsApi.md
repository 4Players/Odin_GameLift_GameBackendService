...
|------------- | ------------- | -------------|
| [**appsMetadataDeleteAll**](AppsApi.md#appsmetadatadeleteall) | **DELETE** /v1/apps/{app}/metadata | Delete all metadata |
| [**appsMetadataDeleteKeys**](AppsApi.md#appsmetadatadeletekeys) | **DELETE** /v1/apps/{app}/metadata/keys | Delete metadata keys |
| [**appsMetadataSet**](AppsApi.md#appsmetadataset) | **PUT** /v1/apps/{app}/metadata | Set metadata |
| [**appsMetadataUpdate**](AppsApi.md#appsmetadataupdate) | **PATCH** /v1/apps/{app}/metadata | Update metadata |
