...
Name | Type
------------ | -------------
`data` | [Array&lt;ServerConfig&gt;](ServerConfig.md)
...
```typescript
import type { GetServerConfigs200Response } from ''
...
const example = {
  ...
  "links": null,
  "meta": null,
} satisfies GetServerConfigs200Response
...
const exampleParsed = JSON.parse(exampleJSON) as GetServerConfigs200Response
