...
|------------- | ------------- | -------------|
| [**createMinecraftTemplate**](TemplateAppApi.md#createminecrafttemplate) | **POST** /v1/templates/apps/minecraft | Create a Minecraft template app |
| [**createOpenClawTemplate**](TemplateAppApi.md#createopenclawtemplate) | **POST** /v1/templates/apps/openclaw | Create an OpenClaw template app |
| [**createPalworldTemplate**](TemplateAppApi.md#createpalworldtemplate) | **POST** /v1/templates/apps/palworld | Create a Palworld template app |
