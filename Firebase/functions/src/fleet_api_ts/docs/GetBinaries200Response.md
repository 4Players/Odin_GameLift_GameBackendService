...
```typescript
import type { GetBinaries200Response } from ''
...
const example = {
  ...
  "links": null,
  "meta": null,
} satisfies GetBinaries200Response
...
const exampleParsed = JSON.parse(exampleJSON) as GetBinaries200Response
