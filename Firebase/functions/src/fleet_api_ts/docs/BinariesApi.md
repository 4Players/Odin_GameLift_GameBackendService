...
|------------- | ------------- | -------------|
| [**binariesMetadataDeleteAll**](BinariesApi.md#binariesmetadatadeleteall) | **DELETE** /v1/binaries/{binary}/metadata | Delete all metadata |
| [**binariesMetadataDeleteKeys**](BinariesApi.md#binariesmetadatadeletekeys) | **DELETE** /v1/binaries/{binary}/metadata/keys | Delete metadata keys |
| [**binariesMetadataSet**](BinariesApi.md#binariesmetadataset) | **PUT** /v1/binaries/{binary}/metadata | Set metadata |
| [**binariesMetadataUpdate**](BinariesApi.md#binariesmetadataupdate) | **PATCH** /v1/binaries/{binary}/metadata | Update metadata |
