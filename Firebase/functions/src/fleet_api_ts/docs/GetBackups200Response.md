...
```typescript
import type { GetBackups200Response } from ''
...
const example = {
  ...
  "links": null,
  "meta": null,
} satisfies GetBackups200Response
...
const exampleParsed = JSON.parse(exampleJSON) as GetBackups200Response
