...
```typescript
import type { GetServers200Response } from ''
...
const example = {
  ...
  "links": null,
  "meta": null,
} satisfies GetServers200Response
...
const exampleParsed = JSON.parse(exampleJSON) as GetServers200Response
